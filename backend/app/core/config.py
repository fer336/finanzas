...
class Settings:
    ...
    rate_limit_burst: int = 50  # Aumentado para soportar carga inicial del dashboard y OAuth
    ...
    PRODUCTION_FRONTEND_URL: str = os.getenv("PRODUCTION_FRONTEND_URL", "https://finanzas.qeva.xyz")
    DEV_BACKEND_URL: str = os.getenv("DEV_BACKEND_URL", "http://localhost:8000")
    PRODUCTION_BACKEND_URL: str = os.getenv("PRODUCTION_BACKEND_URL", "https://finanzas.qeva.xyz")
    ...
    MINIO_SECURE: bool = os.getenv("MINIO_SECURE", "true").lower() in ("true", "1", "yes")
    MINIO_REGION: str = os.getenv("MINIO_REGION", "us-east-1")
    
    # Configuración de archivos
    MAX_FILE_SIZE_MB: int = 10
    ALLOWED_FILE_EXTENSIONS: List[str] = [".jpg", ".jpeg", ".png", ".pdf", ".webp", ".gif"]
