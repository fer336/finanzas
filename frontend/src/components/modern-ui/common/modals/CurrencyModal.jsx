...
/**
 * CurrencyModal — alta/edición de moneda personalizada, tema "Kanagawa".
 * Mismo patrón visual que PaymentMethodModal/CategoryModal (overlay
 * rgba(32,36,44,.4), panel #e5ddb0, radius 12px). `icono`/`color` se
...
export const CurrencyModal = ({ isOpen, onClose, onSave, currency = null }) => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4" style={{ background: 'rgba(32,36,44,.4)' }}>
      <div className="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-xl border border-[#c8bf91] dark:border-[#363646] bg-[#e5ddb0] dark:bg-[#181820]">
        <div className="sticky top-0 z-20 flex items-center justify-between border-b border-[#c8bf91] dark:border-[#363646] bg-[#e5ddb0] dark:bg-[#181820] px-5 py-4 sm:px-6">
          <div className="flex items-center gap-3">
            <div className="rounded-sm bg-[#e4d794] dark:bg-[#2a2a37] p-2">
            ...
            <div>
              ...
              <p className="text-[12.5px] text-[#625f55] dark:text-[#c8c093]">
          ...
          <button
            type="button"
            onClick={onClose}
            className="rounded-sm p-2 text-[#625f55] dark:text-[#c8c093] transition-colors hover:bg-black/5 hover:text-foreground"
          >
            <X className="h-5 w-5" />
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5 p-5 sm:p-6">
          {/* Vista previa */}
          <div className="flex items-center gap-3 rounded-sm border border-[#c8bf91] dark:border-[#363646] bg-white dark:bg-[#2a2a37] px-4 py-3">
            <div className="rounded-sm bg-[#e4d794] dark:bg-[#2a2a37] p-2 text-xl leading-none">{previewEmoji}</div>
            <div>
              <p className="font-mono text-[10px] uppercase tracking-[.08em] text-[#625f55] dark:text-[#c8c093]">Vista previa</p>
              <p className="font-serif text-[15px] font-semibold text-foreground">
                {formData.codigo || 'XXX'} — {formData.nombre || 'Nombre'}
              </p>
              <p className="text-[12px] text-[#625f55] dark:text-[#c8c093]">Símbolo: {formData.simbolo || '?'}</p>
            </div>
          </div>

          <div>
            <label className="mb-1.5 block text-[12.5px] font-medium text-[#43436c] dark:text-[#c8c093]">Código ISO *</label>
            <input
              type="text"
              ...
              maxLength={10}
              className="w-full rounded-sm border border-[#c8bf91] dark:border-[#363646] bg-white dark:bg-[#2a2a37] px-3.5 py-2.5 text-[13.5px] text-foreground placeholder:text-[#625f55] dark:placeholder:text-[#c8c093] focus:outline-none focus:ring-2 focus:ring-ring"
            />
            {errors.codigo && (
              <p className="mt-1 flex items-center gap-1 text-[11.5px] text-[#b83245] dark:text-[#e46876]">
                <AlertCircle className="h-3 w-3" /> {errors.codigo}
              </p>
            )}
            <p className="mt-1 text-[11.5px] text-[#625f55] dark:text-[#c8c093]">Código de 3-10 letras mayúsculas (ej: USD, EUR, BTC, USDT)</p>
          </div>
          ...
          <div>
            <label className="mb-1.5 block text-[12.5px] font-medium text-[#43436c] dark:text-[#c8c093]">Símbolo *</label>
            <input
              type="text"
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              ...
              <select
                ...
                className="w-full rounded-sm border border-[#c8bf91] dark:border-[#363646] bg-white dark:bg-[#2a2a37] px-3.5 py-2.5 text-[13.5px] text-foreground focus:outline-none focus:ring-2 focus:ring-ring"
              >
          ...
          {errors.submit && (
            <div className="rounded-sm border border-[#b83245]/40 dark:border-[#e46876]/40 bg-[#b83245]/5 dark:bg-[#e46876]/5 p-3.5 text-[12.5px] text-[#b83245] dark:text-[#e46876]">
              {errors.submit}
            </div>
          )}
          ...
          <div className="flex gap-3 pt-1">
            <button
              type="button"
              onClick={onClose}
              className="flex-1 rounded-sm border border-[#c8bf91] dark:border-[#363646] bg-white dark:bg-[#2a2a37] px-4 py-2.5 text-[13.5px] font-medium text-foreground transition-colors duration-150 hover:bg-[#e4d794] dark:hover:bg-[#2a2a37]"
            >
              Cancelar
            </button>
            <button
              type="submit"
              disabled={saving}
              className="flex flex-1 items-center justify-center gap-2 rounded-sm bg-primary px-4 py-2.5 text-[13.5px] font-semibold text-primary-foreground transition-colors duration-150 hover:bg-[#5f7841] dark:hover:bg-[#76946a] disabled:opacity-50"
            >
