...
const KpiCard = ({ label, value, subtext, borderColor, valueColor }) => (
  <div
    className="rounded-md border border-[#ddd5c2] dark:border-[#2e3844] bg-card px-2.5 py-3 sm:px-[18px] sm:py-4"
    style={{ borderTop: `3px solid ${borderColor}` }}
  >
    <div className="truncate text-[10px] uppercase tracking-[.06em] text-[#8a8677] dark:text-[#93a0af] sm:text-[11px]">{label}</div>
    <div
    ...
    {subtext ? <div className="mt-0.5 truncate text-[11px] text-[#8a8677] dark:text-[#93a0af] sm:text-[12px]">{subtext}</div> : null}
  </div>
);
