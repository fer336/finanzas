  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
        <div className="relative flex max-h-[90vh] w-full max-w-lg flex-col overflow-hidden rounded-xl border border-[#ddd5c2] bg-[#faf7ef]">
          <div className="flex items-center justify-between border-b border-[#ddd5c2] bg-[#faf7ef] px-6 py-5 sm:px-8">
          ...
          <form onSubmit={handleSubmit} className="flex-1 space-y-5 overflow-y-auto p-6 sm:p-8">
            <div className="flex flex-col gap-1.5">
              <label className="text-[12.5px] font-medium text-[#5d6470]">¿Quién te prestó?</label>
              <input
                type="text"
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div className="flex flex-col gap-1.5">
                <label className="text-[12.5px] font-medium text-[#5d6470]">Monto prestado</label>
                <input
                  type="number"
                  step="0.01"
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-[12.5px] font-medium text-[#5d6470]">Monto a devolver</label>
                <input
                  type="number"
                  step="0.01"
            ...
            <p className="-mt-3 text-[11.5px] text-[#8a8677]">Puede diferir del monto prestado si hay interés.</p>
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-[12.5px] font-medium text-[#5d6470]">Notas (opcional)</label>
              <textarea
          ...
          <div className="flex items-center justify-end gap-3 border-t border-[#ddd5c2] bg-[#faf7ef] px-6 py-5 sm:px-8">
            <button
              type="button"
              onClick={onClose}
              disabled={saving}
